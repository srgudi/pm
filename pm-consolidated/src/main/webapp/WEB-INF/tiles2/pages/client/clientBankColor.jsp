...
$().ready(function() {
	        ...
	        var validator = $("#partyAccount").validate({
	            ...
	            submitHandler: function(form) {
				        ...
				        success: function(clientId) {
		            		...
		            		$("#ClientBankGrid").setGridParam({datatype:'json', page:1}).trigger('reloadGrid');
		            		}
		            	 else{
	 ...
	 $("#backToList").click(function(){
			...
			$('#clientBankTabs a:last').tab('show');
			$('#clientBankTabs a:first').tab('hide');
			});
	 });
...
<div class="fieldset">
<div class="f13">
<form:form modelAttribute="partyAccount" action="clientBank.do">
...
<b><strong>${inValidClientId}</strong></b> 
 <div class="container_12 mt20">
				 ...
				 <div class="span3">
                  ...
                  <form:input path="accountEntityName" cssClass="input_full" tabindex="1"/>
				</div>
				<div class="span3">
				  <form:label path="accountNumber"><spring:message code="label.accountnumber"/></form:label>
                  <form:input path="accountNumber" cssClass="input_full" tabindex="2"/>
				</div>
				<div class="span3">
				...
				<div class="row">	
				 <div class="span3">
                  ...
                  <form:input cssClass="input_full" path="address.addressLine1" class="input" tabindex="4"/>
				 </div>
				 <div class="span3">
				  <form:label path="address.addressLine2"><spring:message code="label.addressline2"/></form:label>
                  <form:input cssClass="input_full" path="address.addressLine2" class="input" tabindex="5"/>
				 </div>
				 <div class="span3">
				  <form:label path="address.city"><spring:message code="label.city"/></form:label>
                  <form:input cssClass="input_full" path="address.city" class="input" tabindex="6"/>
				 </div>
				</div>
				<div class="row">	
				 <div class="span3">
				 ...
				 <form:label path="address.postalCode" cssClass="input_full"><spring:message code="label.postelcode"/></form:label>
                  <form:input path="address.postalCode"
                        cssClass="input_full" tabindex="9"/>
				 </div>
				</div>
				<div class="row">	
				 <div class="span3">
            			...
            			<c:forEach items="${partyAccount.defaultPointOfContact.phoneList}" var="contact" varStatus="cStatus">
			                <table width="100%">
			                    <tr class="phonerow">
			                        ...
			                        <td width="10%"><form:input style="width: 150px;"
			                                path="defaultPointOfContact.phoneList[${cStatus.index}].contactDetail"
			                                cssClass="inputnew" tabindex="${tabOrder}"/>
			                        </td>
			                        <form:hidden
									...
									<td width="3%"></td>
			                        <% /** Phone Type **/ %>
			                         <td width="7%" class="grid_5 right" style="text-align:center; color : #00498F"><spring:message code="label.phonetype"/></td>
			                        ...
			                        <td class="span1"><form:select class="span1" style="width: 120px;"
			                                path="defaultPointOfContact.phoneList[${cStatus.index}].subType"
			                                id="phone_type" cssClass="selectnew" tabindex="${tabOrder}">
			                            <form:option value="-1" label="Select"/>
