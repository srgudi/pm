		...
		$.ajax({
            ...
            success: function(clientId) {
	         if(clientId != -1){
    			...
    			$('#getAllStaff').dataTable().fnReloadAjax('mainClientList.do?clientId=' + clientId);
    			window.location.href='clientDetail.do?clientId=' + clientId;
        		if(editStatus==true){
        			 $('#stfhome').show();
			...
			<b><strong>${inValidClientId}</strong></b>
               ...
               <div class="container_12 mt20">
				...
				<div class="span3">
                    ...
                    <form:input path="person.firstName" cssClass="formInput" tabindex="1"/>
                 </div>  
                 <div class="span3">
                  <form:label   path="person.lastName"><spring:message code="label.lastname"/></form:label>
                  <form:input path="person.lastName" cssClass="formInput" tabindex="2"/>
                </div>
                   <div class="span3">
                    <form:label  path="person.personDetails.codeByJobTitleCode"><spring:message code="label.title"/></form:label>
                    <form:select path="person.personDetails.codeByJobTitleCode" tabindex="3" cssClass="formSelect">
                   ...
                   <form:label   path="person.personDetails.comittee" ><spring:message code="label.com"/></form:label> 
                    ...
                    <form:input path="person.personDetails.comittee" cssClass="formInput" tabindex="4"/>
                    </div>
                    <div class="span3">
                    ...
                    <form:input path="person.personDetails.annualCompensation" cssClass="formInput" tabindex="6"/>
                </div>
                </div>
                     <div class="row">	
				     <div class="span3">
                    <form:label   path="defaultPartySite.address.addressLine1"><spring:message code="label.addressline1"/></form:label>
                   <form:input path="defaultPartySite.address.addressLine1" cssClass="formInput" tabindex="7"/>
                    </div>
                   <div class="span3">
                   <form:label   path="defaultPartySite.address.addressLine2"><spring:message code="label.addressline2"/></form:label>
                   <form:input path="defaultPartySite.address.addressLine2" cssClass="formInput" tabindex="8"/>
                   </div>
                            <div class="span3">
                       <form:label   path="defaultPartySite.address.city"><spring:message code="label.city"/></form:label>
                    <form:input path="defaultPartySite.address.city" cssClass="formInput" tabindex="9"/>
                    </div>
                    </div>
                     <div class="row">	
				     <div class="span3">
                    <form:label   path="defaultPartySite.address.countryCode"><spring:message code="label.country"/></form:label>
                    <form:select path="defaultPartySite.address.countryCode" cssClass="formSelect" tabindex="10">
                        	<form:option value="-1" label="Select"/>
                    ...
                    <form:select path="defaultPartySite.address.stateCode" cssClass="formSelect" tabindex="11">
                        	<form:option value="-1" label="Select"/>
                   ...
                   <form:input path="defaultPartySite.address.postalCode" cssClass="formInput" tabindex="12"/>
                  </div>
                  </div>
                      ...
                      <form:label 
                         ...
                         <form:hidden path="defaultPartySite.defaultPointOfContact.emailList[${cStatus.index}].id"/>
                            ...
                            <form:input
                                    ...
                                    tabindex="13" id= "email" cssClass="formInput"/>
			                ...
			                <c:set var="rowCount" value="${rowCounter.count}"/>
			                    <tr class="phonerowForStaff">
			                        ...
			                        <td width="20%"><form:input style="width: 150px;"
			                                ...
			                                cssClass="input phoneFieldForStaff" tabindex="${tabOrder}"/>
			                        </td>
			                        <form:hidden
			                        ...
			                        <td class="row-nav1"><form:select style="width: 120px;"
			                            ...
			                            <a href="javascript:;" class="addphone" style="text-decoration:none;"><img
			                                ...
			                                class="addiconForStaff" />
			                        </a> &nbsp; 
			                        <a href='javascript:;' class='removeiconForStaff'
            ...
            <form:hidden path="defaultPartySite.defaultPointOfContact.contactTitle" class="input"
            	...
            	<security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
						...
						&nbsp;&nbsp;
	                    	...
	                    	<a href="#home" onclick=StaffList(); data-toggle="tab" style="text-decoration:none;"> 
	                    <button type="button"
...
var x = ${rowCount};
    $('.addiconForStaff').click(function() {
        if ($("tr.phonerowForStaff").length < 5) {
          /*   var x = $("input[class^='input phoneFieldForStaff']").length; */

            $("table tbody").find("tr.phonerowForStaff:last").clone(true).insertAfter("tr.phonerowForStaff:last").find("input[class^='input phoneFieldForStaff']").attr({
            ...
            $("table tbody").find("tr.phonerowForStaff:last").find("select[class^='phone_type']").attr({
            ...
            $("table tbody").find("tr.phonerowForStaff:last").find("input[class='input_h1_id']").attr({
                name: 'defaultPartySite.defaultPointOfContact.phoneList[' + (x) + '].id',
                id: 'defaultPartySite.defaultPointOfContact.phoneList[' + (x) + '].id'})
                    .val("");


            $("table tbody").find("tr.phonerowForStaff:last").find("input[class='input_h1']").attr({
    ...
    $(".removeiconForStaff").click(function () {
        $(this).parent().parent().remove();
    });

    function firstrowLength() {
        if ($("tr.phonerowForStaff").length > 1) {
            $("tr.phonerowForStaff:last").find("td:last").find("a.removeiconForStaff").show();
        }
    }
    function StaffList(){
    	$('#stfTabs a:first').tab('show');
