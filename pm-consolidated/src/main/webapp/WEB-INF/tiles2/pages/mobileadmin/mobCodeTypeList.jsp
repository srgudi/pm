...
<div id="selectDelRow" class="modal" style="display: none; margin-top:10">
	...
	<table  border="0" class="table table-striped table-hover table-bordered mb20" id="getcodetypemob">
	<colgroup>
					<col style="width: 10%;">
					<col style="width: 25%;">
					<col style="width: 35%;">
...
$('#getcodetypemob').dataTable( {
	/* "bJQueryUI": true, */
	"bJQueryMobileUI" : true,
	"sPaginationType" : "bootstrap",
	"bLengthChange": true,
	"sAjaxSource": '/pm-new/appadmin/codeTypeList.do',
	"bFilter": true,
    "bAutoWidth": false,
    "sInfoFiltered": " ",
...
$('#deletedRecord').click(function() {
	...
	if ($(this).data('action') == 'deletedRecord') {
		...
		URL = '/pm-new/appadmin/saveCodeType.do?id=' + selectedItems;
	}
	...
	$.ajax({
		...
		success : function(data) {
			if (data) {
				$('#getcodetypemob').dataTable().fnDraw();
...
function editcodeType(partyId) {
	//alert("hi");
	window.location = '/pm-new/mobileadmin/mobileAdminCodeType.do?id=' + partyId;
	//showTaxform();
	return false;
}
</script>	
