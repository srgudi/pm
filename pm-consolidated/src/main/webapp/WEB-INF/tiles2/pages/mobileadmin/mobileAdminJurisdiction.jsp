	...
	<div id="div2">
		...
		<form:form name="jurisdiction" modelAttribute="jurisdiction">
			...
			<input type="hidden" name="baseURL" id="baseURL"
				value="mobileAdminJurisdiction.do" />
			...
			<div data-role="fieldcontain">
				...
				<form:select path="timezone" cssClass="input_full" tabindex="5">
					...
					<form:options items="${timezoneSet}" itemValue="id"
						itemLabel="globalTimezoneName" />
				</form:select>
			</div>
			<div data-role="fieldcontain">
	...
	<!-- <div id="grid">	
			...
			jQuery("#jurisdictionList").jqGrid({
				 "hoverrows":false,
		            ...
		            "gridview":true,
		            "loadonce":true,
		            "url":'<c:url value="/appadmin/jurisdictionsList.do"/>?firmId='+firmId,
		            "scrollPaging":true,
		            pager : jQuery('#pager'),
		            "rowNum":10,
		            "rowList" : [20,40,60],
