...
<c:url value="/mobileclient/mobileClientInsurance.do"
	var="mobileInsuranceModuleUrl">
...
<security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
	<a href="<c:out value='${mobileInsuranceModuleUrl}'/>"
		style="text-decoration: none;">
		<button type="button" id="showInsuranceForm"
...
<div id="confirmDelId" class="modal" style="display: none;">
	...
	<div class="modal-footer">
		<span id="deleteConfrmdId" data-action="deleteConfrmdId"
...
<div id="selectId" class="modal" style="display: none;">
	...
	<div class="modal-footer">
		<span id="selectCdId" data-action="deleteConfirmed"
...
<div id="grid_wrapper" style="overflow: auto;">
	<table border="0"
		...
		id="getAllIns">
		<caption title="" class="captionFont">Insurance List</caption>
		<colgroup>
			<col style="width: 5%;">
			<col style="width: 15%;">
			<col style="width: 15%;">
	...
	$(function(){
	   ...
	   $("#getAllIns").dataTable({
		   "bJQueryMobileUI" : true,
			...
			"sAjaxSource": 'mobileAccountAjaxList.do?clientId=' + clientId + '&accountCategory=701',
			"bProcessing" : 'true',
			"bServerSide" : 'true',
			"bDeferRender" : 'false',
			"oTableTools" : {
...
function InsuranceEdit(id){
	var clientId = ${clientId};
	window.location = 'mobileClientInsurance.do?clientId='+clientId+'&id='+id;
}
</script>
