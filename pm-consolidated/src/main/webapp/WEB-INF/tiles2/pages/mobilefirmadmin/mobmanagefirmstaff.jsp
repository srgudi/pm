			...
			$("#save").click(function() {
				/* $.ajax({
			         ...
			         type: 'POST',
				       ...
				       url: 'manageFirmStaffMobile.do',
				       success: function(id) {
				           	if(id != -1){
				        		$.jGrowl("Record saved successfully");
				        		var tabl = $("#getFirmStaffnewmob").dataTable();
				        		tabl.fnDraw();
		       				}else{
				 ...
				 if ($('#party').validate({
						...
						'defaultPartySite.defaultPointOfContact.emailList[0].contactDetail': {required: true, email:true,emailIdExists:true},
		        	...
		        	messages: { 
						...
						'defaultPartySite.defaultPointOfContact.emailList[0].contactDetail': {
		            		...
		            		emailIdExists:"Please enter a new Email ID. This mail Id already exists."},
					        		...
					        		$.jGrowl("Record saved successfully");
					        		 if(status==true){
		 	   	                		//	var clientId = ${clientId};
		 	   	                			window.location = 'firmStaffMobileList.do';
		 	   	                		}else{
		 	   	                			//var clientId = ${clientId};
		 	   	                			document.getElementById("party").reset();
		 	   	                		$('#getFirmStaffnewmob').dataTable().fnReloadAjax('manageFirmStaffList.do');
		 	   	                		}  
			       				}else{
					           		 $.jGrowl("As Error has happened while process. ");	
				            	 } 
			...
			<form:form modelAttribute="party">
               ...
               <div data-role="fieldcontain">
                   ...
                   <div data-role="fieldcontain">
                    ...
                    <c:forEach items="${party.defaultPartySite.defaultPointOfContact.emailList}" 
                                   varStatus="cStatus">
                     <div data-role="fieldcontain">              
                    ...
                    <c:forEach items="${party.defaultPartySite.defaultPointOfContact.faxList}" 
                                   varStatus="cStatus">
                         <div data-role="fieldcontain">           
                        <form:label 
...
<br/><br/>
            	...
            	<security:authorize access="hasAnyRole('ROLE_FIRM_ADMIN','ROLE_APP_ADMIN')">
                    ...
                    <button id="showFirmStaffGrid" onclick="window.location='firmStaffMobileList.do';return false;"
	                 class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
	                 role="button" aria-disabled="false" data-inline="true" data-mini="true">
