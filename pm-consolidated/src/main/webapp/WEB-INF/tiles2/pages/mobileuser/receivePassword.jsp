...
.container {margin-left: 40px;}
 ...
 <div class="navbar navbar-inverse navbar-fixed-top" style="color : #00477D">
	...
	<c:if test="${not empty error}">
	 ...
	 <div class="span9">
	 <br/><br/><br/><br/>
 <form modelAttribute="newuser" action="receivePasswordMobile.do" method="POST" class="hero-unit">
	...
	<h3>Password Reset</h3>
          ...
          <!-- <div class="input-xlarge"> -->
           <input type='password' tabindex="2" id="newuser.newPassword" name='newpassword' onkeyup="return passwordChanged();"><br/>
          <!-- </div> -->
         ...
         <!--  </div> -->
            ...
            <div class="actions">
				<input tabindex="3" class="btn btn-large btn-info" type="submit"
					value="Save">
            </div>
          </div>
