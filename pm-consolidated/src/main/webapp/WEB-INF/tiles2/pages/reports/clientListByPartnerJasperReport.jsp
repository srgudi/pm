...
<spring:message code="label.clientListByPartner"/></div>
...
<div>
	<form:form modelAttribute="taskRep" method="POST" action="clientListbyPartner.do" name="test" target="report">
...
<INPUT TYPE="HIDDEN" NAME="ReportName" Value="ClientListByPartnerIncharge.jrxml">	
	<input type="hidden" name="baseURL" id="baseURL" value="clientListbyPartner.do" /> 	
