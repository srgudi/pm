...
<script type="text/javascript">
    ...
    $("#save").click(function() {
    	 ...
    	 //alert(firmid);
          ...
          $("#ReportName").val("ClientListWithDetails.jrxml");
          if($("#view").val()!="xls" ){
       		  if($("#view").val()!="csv" ){
...
<spring:message code="label.clientListWithDetails"/></div>
...
<div>
	<form:form modelAttribute="taskRep" method="POST" action="clientListwithDetails.do" name="test" target="report">
  ...
  <INPUT TYPE="HIDDEN" id="ReportName" NAME="ReportName" Value="ClientListWithDetails.jasper">
	<input type="hidden" name="baseURL" id="baseURL" value="clientListwithDetails.do" /> 	
	<br/>
	<br/>
