...
<spring:message code="label.workLoadSummary"/></div>
...
<div>
	<form:form modelAttribute="taskRep" method="POST" action="newTaxListByStaff.do" name="test" target="report">
  ...
  <input type="hidden" name="taskId" value="2"/>
	<input type="hidden" name="baseURL" id="baseURL" value="newTaxListByStaff.do" />
	...
	<table class="ui-widget" border="0" id="controls1"
		...
		<tbody>		
			...
			<tr>
				<td><spring:message code="label.inChargeType"/></td>
				<td>
