...
<script type="text/javascript">
    ...
    $("#save").click(function() {
    	...
    	if(tempDate.length==0){
    		...
    		$("#errMsg").text("Please select Filing Type");
    		$("#errMsg").css('color','red');
    		return;
    	}else if(sortType==-1){
...
<spring:message code="label.taskListByFilingType"/></div>
...
<div>
	<form:form modelAttribute="taskRep" method="POST" action="taskListByFilingType.do" name="test" target="report">
  ...
  <INPUT TYPE="HIDDEN" NAME="ReportName" Value="classpath:taskListByFilingTypeJ.jrxml">
	<input type="hidden" name="baseURL" id="baseURL" value="taskListByFilingType.do" /> 	
	...
	<table class="ui-widget" border="0" id="controls1"
		...
		<tbody>		
			...
			<tr>
			 ...
			 <tr class="odd" >
                  <td class="col-first"><spring:message code="label.filingType"/></td>
                  <td class="col-second">
                  		<form:select path="filingType" id="fType" tabindex="7"  style="width: 150px">
			...
			<tr>
				...
				<form:select path="sortAs" id="sort" tabindex="3" width="150" style="width: 150px">
					<form:option value="-1" label="Select" />
					<form:option value="PName">Firm Staff</form:option>
...
// 		document.test.filingtypeid.value=document.getElementById("fType").value;
// 		document.test.srt.value=document.getElementById("sort").value;
		...
		//alert("Date is "+d2);
		$("#firmid").val(firmid);
		$("#filingtype").val($("#fType").val());
		//alert($("#filingtype").val());
		$("#srt").val($("#sort").val());
