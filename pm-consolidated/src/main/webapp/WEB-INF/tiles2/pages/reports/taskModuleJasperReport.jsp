...
<script type="text/javascript">
    ...
    $("#save").click(function() {
    	...
    	/*if ( ( form.Days[0].checked == false ) && ( form.Days[1].checked == false ) ) 
    	{ 
    		$("#errMsg").text("Please Choose any Days Option.");
    		$("#errMsg").css('color','red');
	  ...
	  if($("#view").val()!="xls" ){
		...
		$("#taskRep").submit();
    	//document.getElementById("report").src="../../reports/frameset?__report=taskbypartner.rptdesign&dueDate="+document.test.date1.value+"&dueDate1="+document.test.date2.value+"&partnerId="+document.test.partnerId.value+"&firmId="+firmid+"&srt="+document.test.srt.value+"&__format=pdf";
    	//window.location="../../reports/frameset?__report=barchart.rptdesign";
		//$("#testRep").submit();
	});
    });
...
<div>
<form:form modelAttribute="taskRep" method="POST" action="taskListByPartner.do" name="test" target="report">
  ...
  <INPUT TYPE="HIDDEN" NAME="ReportName" Value="TaskListByPartner.jrxml">
	<input type="hidden" name="baseURL" id="baseURL" value="taskListByPartner.do" /> 	
	...
	<table class="ui-widget" border="0" id="controls1"
		...
		<tbody>
			...
			<tr>
			 ...
			 <tr class="odd">
                  <td class="col-first"><spring:message code="label.partnerInCharge"/></td>
                  <td class="col-second">
			...
			<tr>
				...
				<form:select path="sortAs" id="sort" tabindex="3" width="150" style="width: 150px">
					...
					<form:option value="CName">Client Staff In Charge</form:option>
					<form:option value="TName">Task Name</form:option>
...
//	document.test.date1.value=dueDate2;
	//alert(document.test.dueDate1.value);
