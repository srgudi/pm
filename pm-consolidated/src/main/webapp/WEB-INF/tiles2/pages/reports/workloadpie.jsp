...
<script type="text/javascript">
    ...
    $("#save").click(function() {
    	 ...
    	 //alert(firmid);
          ...
          $("#ReportName").val("PieChartJasperReport.jrxml");
          if($("#view").val()!="xls" ){
       		  if($("#view").val()!="csv" ){
...
Workload Distribution Among Staff</div>
...
window.onload = function(){
 	...
 	//document.getElementById("report").src="../../reports/frameset?__report=barchart.rptdesign";
 	//var url="../../reports/frameset?__report=PieChartJasperReport.rptdesign&&firmid="+firmid+"&__format=pdf";
 	
 	//document.getElementById("report").src="../../reports/frameset?__report=PieChartJasperReport.rptdesign&firmid="+firmid+"&__format=pdf";
	}
...
<div>
	<form:form modelAttribute="taskRep" method="POST" action="pieChartJasperReport.do" name="test" target="report">
  ...
  <INPUT TYPE="HIDDEN" id="ReportName" NAME="ReportName" Value="PieChartJasperReport.jasper">
	<input type="hidden" name="baseURL" id="baseURL" value="pieChartJasperReport.do" /> 	
