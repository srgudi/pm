...
/*		 $.validator.addMethod('lastName', function(value, element) {
    ...
    $().ready(function() {
    	  ...
    	  /* $("#newback").click(function() {
    		  window.location.href='/client/mainClient.do';
    	    }); */
...
<script>
	function submitForm(){
	 ...
	 function changetheme(theme) {
		 alert("hi");
		 $.post("<c:url value='/theme/themeSelect.do'/>", {theme: theme}, function(data) {
			 /* alert("hi"); */
        });
       }
...
<div class="error_container">
    ...
    <ol></ol>
			...
			<div style="padding:5px;" class="headerCap">User Profile</div>
<div class="well">		
...
<div class="row">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
<div class="span3">
       <form:label path="person.userName"><span style="color:black;">User Name</span></form:label>
       <form:input cssClass="input_full" path="person.userName" class="input" tabindex="1" readonly="true" disabled="true"/>
</div>
<div class="span3">
<form:label path="person.firstName"><span style="color:black;">First Name</span> <span style="color:red;margin-left:3px;">*</span></form:label>
<form:input cssClass="input_full" path="person.firstName" class="input" tabindex="3"/>
</div>
<div class="span3">
<form:label path="person.lastName"><span style="color:black;">Last Name</span> <span style="color:red;margin-left:3px;">*</span></form:label>
<form:input cssClass="input_full" path="person.lastName" class="input" tabindex="4"/>
</div>
</div>
<div class="row">&nbsp;	
<div class="span3">
<form:label path="defaultPartySite.address.addressLine1"><span style="color:black;">Address Line 1</span> <span style="color:red;margin-left:3px;">*</span></form:label>
<form:input cssClass="input_full" path="defaultPartySite.address.addressLine1" class="input" tabindex="5"/>
</div>
<div class="span3">
<form:label path="defaultPartySite.address.addressLine2"><span style="color:black;">Address Line 2</span></form:label>
<form:input cssClass="input_full" path="defaultPartySite.address.addressLine2" class="input" tabindex="6"/>
</div>
<div class="span3">
<form:label path="defaultPartySite.address.city"><span style="color:black;">City </span><span style="color:red;margin-left:3px;">*</span></form:label>
<form:input cssClass="input_full" path="defaultPartySite.address.city" class="input" tabindex="7"/>
</div>
</div>
<div class="row">&nbsp;	
<div class="span3">
<form:label path="defaultPartySite.address.countryCode"><span style="color:black;">Country </span><span style="color:red;margin-left:3px;">*</span></form:label>
<form:select
       path="defaultPartySite.address.countryCode" cssClass="input_full" tabindex="8">
       <form:option value="-1" label="Select"/>
       <form:options items="${countryCodeSet}" itemValue="key"
...
<div class="span3">
<form:label path="defaultPartySite.address.stateCode"><span style="color:black;">State/Province </span><span style="color:red;margin-left:3px;">*</span></form:label>
<form:select
       path="defaultPartySite.address.stateCode" cssClass="input_full" tabindex="9">
       <form:option value="-1" label="Select"/>
       <form:options items="${statesSet}" itemValue="key"
...
<div class="span3">
<form:label path="defaultPartySite.address.postalCode"><span style="color:black;">Postal Code </span><span style="color:red;margin-left:3px;">*</span></form:label>
<form:input cssClass="input_full" path="defaultPartySite.address.postalCode" class="input"  tabindex="10"/>
</div>
</div>
<div class="row">	
<div class="span3">
<form:label path="">Theme Selector</form:label>
<select name="themeValue" onChange="changetheme(value);" tabindex="11" cssClass="input_full" style="width:312px;" readonly="true" disabled="true">
                    <option value="bootstrap.min" cssClass="input_full" >Select</option>
					<option value="cosmo" cssClass="input_full" >Cosmo</option>
					<option value="slate" cssClass="input_full">Slate</option>
					<option value="spruce" cssClass="input_full">Spruce</option>
					<option value="superhero" cssClass="input_full">Superhero</option>
					<option value="united" cssClass="input_full">United</option>
...
<div class="span3">
                    ...
                    <div class="grid_3">&nbsp;</div>
                     <div class="grid_8">
                    	...
                    	<button type="newback" onclick="window.location='../client/mainClient.do';return false;"
                            	class="btn btn-primary"
                            	role="button" aria-disabled="false">
                        	<span class="ui-button-text" tabindex="14">Back To Home</span>
                    	</button>
                    	&nbsp;&nbsp;
