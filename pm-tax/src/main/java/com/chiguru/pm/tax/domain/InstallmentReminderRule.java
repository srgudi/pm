 ...
 */
public class InstallmentReminderRule extends ReminderRule implements java.io.Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "reminder_day_code")
    public Code getReminderDayCode() {
        return reminderDayCode;
    }
}
