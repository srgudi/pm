...
public class AdminTaskNotificationTemplateController {
    ...
    @RequestMapping(value = "/appadmin/adminTaskNotificationTemplate.do", method = RequestMethod.POST)
    public String saveAdminTaskNotificationTemplate(
...
//            notificationTemplate.setCreateUserId("system");
        ...
        String returnURL = baseURL + "?id=" + notificationTemplate.getId()+"&saveSuccess=true";*/
    ...
    @RequestMapping(value = "/mobileadmin/mobileadminTaskNotificationTemplate.do", method = RequestMethod.POST)
    public String saveMobileAdminTaskNotificationTemplate(
        HttpServletRequest request,@ModelAttribute("taskNotificationTemplate") TaskNotificationTemplate notificationTemplate,
        BindingResult result, ModelMap model, Long clientId, Long id) {
        logger.info("save TaskNotificationTemplate !");
...
//            notificationTemplate.setCreateUserId("system");
        ...
        /*String baseURL = request.getParameter("baseURL");
        String returnURL = baseURL + "?id=" + notificationTemplate.getId()+"&saveSuccess=true";*/
        String returnURL = "/mobileadmin/mobileadminTaskNotificationTemplate.do?id=" +
            notificationTemplate.getId() + "&saveSuccess=true";

        return "redirect:" + returnURL;
    }
    
    @RequestMapping(value = "/appadmin/adminTaskNotificationTemplate.do", method = RequestMethod.GET)
    public String getAdminTaskNotificationTemplate(HttpServletRequest request,
        ModelMap model, TaskNotificationTemplate notificationTemplate, Long id) {
   ...
   return "adminTaskNotificationTemplate.tilesView";
    ...
    @RequestMapping(value = "/mobileadmin/mobileadminTaskNotificationTemplate.do", method = RequestMethod.GET)
    public String getMobileAdminTaskNotificationTemplate(HttpServletRequest request,
        ModelMap model, TaskNotificationTemplate notificationTemplate, Long id) {
        logger.info("Get TaskNotificationTemplate !");
        PMUtil.showStatusMessage(request, model);
        model.addAttribute("taskNotificationTemplate", notificationTemplate);
