...
public class MobileClientListController{
    ...
    private TaxModuleManager taxModuleManager;
	 ...
	 @RequestMapping(value = "/mobileclient/mobileClientList.do", method = RequestMethod.GET)
	   public String mobileClientList(HttpServletRequest request, 
      ...
      if (session.getAttribute("inValidClientId")!=null) {
      	 session.setAttribute("clientPartyName", "");
	        ...
	        return "mobileClientList.tilesView";
	    }
	 
	 @RequestMapping(value = "/mobileclient/mobileClientGetList.do", method = RequestMethod.GET)
	    public @ResponseBody
	 ...
	 @RequestMapping(value = "/mobileclient/mobileClientDetail.do", method = RequestMethod.GET)
	   public String mobileClientDetail(HttpServletRequest request,  ModelMap model,Organization clientOrganization, Long clientId) {
