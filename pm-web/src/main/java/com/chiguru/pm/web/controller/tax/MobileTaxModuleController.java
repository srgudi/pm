...
@Controller
public class MobileTaxModuleController{
	
	 private Logger logger = org.slf4j.LoggerFactory.getLogger(MobileTaxModuleController.class);
	@Autowired
...
//                    rule.setLastUpdateUserId("system");
    ...
    @RequestMapping(value = "/mobiletax/mobiletaxModuleList.do", method = RequestMethod.GET)
    public @ResponseBody
    Map getMobileTaxModuleList(HttpServletRequest request, Long clientId,
        Long firmPracticeId) {
    ...
    @RequestMapping(value="/mobiletax/mobileTaxModule.do",method=RequestMethod.GET)
	public String getmobileTaxModule(HttpServletRequest request,ClientPracticeInfo practiceInfo, Long firmPracticeId, Long clientId,ModelMap model){
    ...
    @RequestMapping(value = "/mobiletax/mobileTaxModule.do", method = RequestMethod.POST)
    public String savemyTaxModule(HttpServletRequest request,
        ClientPracticeInfo practiceInfo, Long firmPracticeId, Long clientId,
        ModelMap model, List[] delteListArray) {
        logger.info("Mobile Tax Module!");
       ...
       /* if (!request.getRequestURI().contains("/appadmin/adminFirmModule.do") &&
        ...
        model.put("yesNoList", PMConstants.YES_NO_LIST);
        model.put("taxModules", taxModuleManager.getFirmPracticeTypeList(firmId));
        Long pId = practiceInfo.getId();
        String baseURL = request.getParameter("baseURL");
        String returnURL = baseURL + "?id=" + pId +
            "&firmPracticeId=" + firmPracticeId + "&clientId=" + clientId +
            "&saveSuccess=true";
      /*  String returnURL = baseURL + "?firmPracticeId=" + firmPracticeId + "&clientId=" + clientId +
        "&saveSuccess=true";*/
