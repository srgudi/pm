...
public class UserProfileController {
	...
	@RequestMapping(value = "/user/userProfile.do", method = RequestMethod.GET)
	public String userProfile(HttpServletRequest request, ModelMap model,
		...
		userprofilemethod(request, model, party);
		return "userProfile.tilesView";
	}
	
	@RequestMapping(value = "/mobileuser/userProfileMobile.do", method = RequestMethod.GET)
	public String userProfileMobile(HttpServletRequest request, ModelMap model,
	        Party party, Long clientId, String clientPartyName) {
		logger.info("user profile select");
		userprofilemethod(request, model, party);
	...
	private void userprofilemethod(HttpServletRequest request, ModelMap model,
			Party party) {
		Long firmId = PMUtil.getFirmIdFromSession(request);
		setReferenceData(party,model, firmId);
		model.addAttribute("party", party);
		
		/*String username = party.getPerson().getUserName();*/
		/*if(username != null){
	 ...
	 @RequestMapping(value = {"/user/userProfile.do","/mobileuser/userProfileMobile.do"}, method = RequestMethod.POST)
	       public String saveUserProfile(HttpServletRequest request, 
	    	        Party staffParty,  SessionStatus status, ModelMap model,
