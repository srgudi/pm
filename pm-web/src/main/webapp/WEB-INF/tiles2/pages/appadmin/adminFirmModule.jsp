...
<div class="fieldset">
<span class="legend b">Firm Information</span>
    <div class="f13">
  <form:form modelAttribute="party" method="POST" action="adminFirmModule.do">
                ...
                <div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;margin-top:-3px">Firm Details</h4></div>
                <div class="container_12 mt20">
                    <div class="grid_2 right"><form:label path="organization.legalName">Firm Name</form:label></div>
                    <div class="grid_3 right"><form:input path="organization.legalName" cssClass="input_full" tabindex="1"/></div>
                     <c:if test="${party.id != null}">
                  	     <a href="adminFirmEmployee.do?newfirmId=${party.id}" name="adminEmployee" class="ui-widget" tabindex="1"   onclick="window.location='adminFirmEmployee.do?newfirmId=${party.id}';return false;" style="text-decoration:none;">
                ...
                <div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;">Location Communication</h4></div>
                <div class="container_12 pt5">
                    ...
                    <div class="grid_3 right"><form:input path="defaultPartySite.address.addressLine1" cssClass="input_full" tabindex="2"/>
                    </div>
                    <div class="s1"></div>
                    <div class="grid_2 right"><form:label   path="defaultPartySite.address.addressLine2">Address Line 2</form:label></div>
                    <div class="grid_3 right"><form:input path="defaultPartySite.address.addressLine2" cssClass="input_full" tabindex="3"/></div>
                </div>

                <div class="container_12 pt5">
                    <div class="grid_2 right"><form:label   path="defaultPartySite.address.city">City</form:label></div>
                    <div class="grid_3 right"><form:input path="defaultPartySite.address.city" cssClass="input_full" tabindex="4"/>
                    </div>
                    <div class="s1"></div>
                    <div class="grid_2 right"><form:label   path="defaultPartySite.address.countryCode">Country</form:label></div>
                    <div class="grid_3 right"><form:select path="defaultPartySite.address.countryCode" cssClass="input_full" tabindex="5">
                ...
                <div class="container_12 pt5">
                    ...
                    <div class="grid_3 right"><form:select path="defaultPartySite.address.stateCode" cssClass="input_full" tabindex="6">
                        	<form:option value="-1" label="Select"/>
                    ...
                    <div class="grid_3 right"><form:input path="defaultPartySite.address.postalCode" cssClass="input_full" tabindex="7"/></div>
                </div>
                
                <div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;">Loction Contact</h4></div>
                <div class="container_12 pt5">
            	...
            	<div class="grid_-12">
                	<a href="adminFirmModule.do" style="text-decoration:none;">
                    	<button type="button" id="newClient"
                    	onclick="window.location='adminFirmModule.do';return false;"
...
<span class="legend b">Firms List</span>
...
jQuery(document).ready(function(){ 
	...
	var mygrid = jQuery("#list").jqGrid({
		...
		colModel :[
			{name:'name', index:'name',  formatter: 'showlink', formatoptions: {baseLinkUrl: 'adminFirmModule.do', 
					idName:'id'}},
