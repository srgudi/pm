...
<span class="legend b">Client Document Upload</span>
    <div class="f13">
        <form:form modelAttribute="documents" method="POST" action="clientDocuments.do" enctype="multipart/form-data">
            <input type="hidden" id="clientId" name="clientId" value="${param.clientId }"/>
            <input type="hidden" name="baseURL" id="baseURL" value="clientDocuments.do"/>
 ...
 <br></br>
           ...
           <div class="container_12" style="margin:10px;"></div>
            ...
            <div class="container_12">
	            ...
	            <div class="grid_8">
	                	<%-- <a href="clientDocuments.do?clientId=${param.clientId}" style="text-decoration:none;">
	                	</a>&nbsp;&nbsp; --%>
