...
<style type="text/css">
		.partyAccount fieldset p.error label { color: red; }
			div.error_container {
			...
			form.partyAccount { width: 30em; }
			form.partyAccount label.error {
				display: block;
				margin-left: 1em;
				width: auto;
			}
...
<div class="f13">
<form:form modelAttribute="partyAccount" method="POST" action="clientInsurance.do">
  ...
  <input type="hidden" name="baseURL" id="baseURL" value="clientInsurance.do"/>
	<form:hidden path="id"/>
		...
		<!-- BEGIN ROW 1 -->
		<div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;margin-top:-3px">Insurance Details</h4></div>
		<div class="container_12 pt5">
            <div class="grid_2 right"><form:label path="accountEntityName">Insurance Firm Name</form:label>      </div>
		    ...
		    <div class="container_12 pt5">
             <div class="grid_2 right"><form:label path="accountNumber">Policy Number</form:label>   </div>
            <div class="grid_3 right"><form:input cssClass="input_full" path="accountNumber" class="input"
             ...
             <div class="grid_2 right"> <form:label path="accountType">Account Type</form:label>     </div>
           ...
           <div class="container_12 pt5">
            ...
            <div class="grid_2 right"><form:label cssClass="label"  path="address.addressLine1">Address Line1</form:label>      </div>
            <div class="grid_3 right"><form:input path="address.addressLine1" cssClass="input_full" tabindex="4"/>      </div>
                        
             <div class="s1"></div>
                    
             <div class="grid_2 right"><form:label cssClass="label"  path="address.addressLine2">Address Line2</form:label>   </div>
            <div class="grid_3 right"><form:input path="address.addressLine2" cssClass="input_full" tabindex="5"/>    </div>
      </div>
		
		
		<div class="container_12 pt5">

            <div class="grid_2 right"><form:label cssClass="label"  path="address.city">City</form:label>      </div>
            <div class="grid_3 right"><form:input path="address.city" cssClass="input_full" tabindex="6"/>      </div>
                        
             <div class="s1"></div>
                    
             <div class="grid_2 right"><form:label cssClass="label" path="address.countryCode">Country</form:label>   </div>
            <div class="grid_3 right"><form:select path="address.countryCode" tabindex="7" cssClass="input_full" >
                        	<form:option value="-1" label="Select"/>
		   ...
		   <div class="container_12 pt5">
            <div class="grid_2 right"><form:label cssClass="label" path="address.stateCode">State/Province</form:label>   </div>
            <div class="grid_3 right"><form:select path="address.stateCode" tabindex="8" cssClass="input_full" >
                        	<form:option value="-1" label="Select"/>
                            <form:options items="${statesSet}" itemValue="key" itemLabel="value"/>
                   		</form:select>    </div>
             <div class="s1"></div>
             <div class="grid_2 right"><form:label cssClass="label"  path="address.postalCode">Postal Code</form:label>      </div>
            <div class="grid_3 right"><form:input path="address.postalCode" cssClass="input_full" tabindex="9"/>      </div>
      </div>
            	<!-- BEGIN ROW 3 -->
         ...
         <div class="container_12 pt5">
            ...
            <div class="grid_3 right"><form:input cssClass="input_full" path="defaultPointOfContact.contactName" class="input"
             ...
             <div class="grid_2 right"> <form:label path="defaultPointOfContact.contactTitle">Title</form:label>  </div>
         ...
         <div class="container_12 pt5">
            ...
            <div class="grid_3 right"><form:hidden
		                ...
		                <form:input
		                        ...
		                        tabindex="12" cssClass="input_full"/>      </div></c:forEach>
                        
             <div class="s1"></div>
               <c:forEach items="${partyAccount.defaultPointOfContact.faxList}" var="contact"
                                   varStatus="cStatus">     
             <div class="grid_2 right"><form:label cssClass="label"
            						path="defaultPointOfContact.faxList[${cStatus.index}].contactDetail">Fax Number</form:label>   </div>
            <div class="grid_3 right"><form:hidden path="defaultPointOfContact.faxList[${cStatus.index}].id"/>
                            <form:hidden
                            ...
                            <form:input
                                    ...
                                    tabindex="13" cssClass="input_full"/>    </div></c:forEach>
      </div>
		...
		<div class="container_12 pt5">
            ...
            <div class="grid_3 right"><form:hidden
			                ...
			                <form:input
			                        ...
			                        tabindex="14" cssClass="input_full"/>      </div></c:forEach>
...
<div class="container_12" style="margin:10px;"></div> 
			...
			<div class="container_12">
            	...
            	<security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
	                	<a href="clientInsurance.do?clientId=${param.clientId}" style="text-decoration:none;">
	                    	<button type="button" id="newClient"
	                    	onclick="window.location='clientInsurance.do?clientId=${param.clientId}';return false;"
	                        	    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
	                            	role="button" aria-disabled="false">
	                        	<span class="ui-button-text">New Insurance</span>
	                    	</button>
	                	</a>&nbsp;&nbsp;
...
<span class="legend b">Insurance List</span>
 ...
 jQuery(document).ready(function(){ 
	...
	var mygrid = jQuery("#list").jqGrid({
	    url:'accountAjaxList.do?clientId='+clientId+'&accountCategory=701',
	    datatype: 'json',
	    
		height : 300,
	    mtype: 'GET',
	    colNames:['ID','Insurance Firm', 'Type Of Insurance', 'Policy No.', 'Contact Name', 'Office Number', 'Email Address'],
	    colModel :[ 
			{name:'id', index:'id',  width:150},
	       {name:'accountFirmName', index:'accountFirmName',  width:200,formatter: 'showlink', formatoptions: {baseLinkUrl: '<c:url value="/client/clientInsurance.do"/>', 
			   idName:'id', addParam:'&clientId='+clientId}},
		   {name:'accountType', index:'accountType',  width:150},
