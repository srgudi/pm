...
<div class="fieldset">
<span class="legend b">Law Firm</span>
<div class="f13">
		...
		<!-- BEGIN ROW 1 -->
		<div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;margin-top:-3px">Law Firm Details</h4></div>
		<div class="container_12 pt5">
            <div class="grid_2 right"><form:label path="accountEntityName">Law Firm Name</form:label>      </div>
		    ...
		    <div class="container_12 pt5">
             <div class="grid_2 right"><form:label path="accountEntityName">Account Number</form:label>   </div>
            <div class="grid_3 right"><form:input cssClass="input_full" path="accountNumber" class="input"
             ...
             <div class="grid_2 right"> <form:label path="accountType">Area of Practice</form:label>     </div>
	...
	<div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;">Address Details</h4></div>
		...
		<div class="container_12 pt5">
            <c:forEach items="${partyAccount.defaultPointOfContact.webUrlList}" var="contact" varStatus="cStatus">
      ...
      <div class="container_12 pt5">
			...
			<div class="container_12">
            	...
            	<security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
	                	<a href="clientLawyer.do?clientId=${param.clientId}" style="text-decoration:none;">
	                    	<button type="button" id="newClient"
	                    	onclick="window.location='clientLawyer.do?clientId=${param.clientId}';return false;"
...
<span class="legend b">Law Firm List</span>
	...
	jQuery(document).ready(function(){ 
		...
		var mygrid = jQuery("#list").jqGrid({
		    url:'accountAjaxList.do?clientId='+clientId+'&accountCategory=703',
		    datatype: 'json',
		    
			height : 300,
		    mtype: 'GET',
		    colNames:['ID','Law Firm Name', 'Type Of Account', 'Account Number', 'Contact Name', 'Office Number', 'Email Address'],
		    colModel :[ 
			   {name:'id', index:'id',  width:150},
		       {name:'accountFirmName', index:'accountFirmName',  width:200,formatter: 'showlink', formatoptions: {baseLinkUrl: '<c:url value="/client/clientLawyer.do"/>', 
				   idName:'id', addParam:'&clientId='+clientId}},
			   {name:'accountType', index:'accountType',  width:180},
			   {name:'accountNumber', index:'accountNumber',  width:150},
