...
var validator = $("#partySite").validate(
{rules: {	  
'name' : {
alphabetsOnly : true,
minlength : 0,
...
<span class="legend b">Client Location Information</span>
    <div class="f13">
                ...
                <div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;margin-top:-3px">Location Details</h4></div>
                <div class="container_12 mt20">
                    <div class="grid_2 right"><form:label path="name">Location Name</form:label></div>
                    <div class="grid_3 right"><form:input path="name" cssClass="input_full" tabindex="1"/></div>
                    <div class="s1"></div>
                    <div class="grid_2 right"><form:label  path="partySiteType">Type of Location</form:label></div>
                    <div class="grid_3 right"><form:select path="partySiteType" tabindex="2" style="width: 100%">
            ...
            <div class="grid_3 right"><form:select
                    path="address.countryCode" cssClass="input_full" tabindex="6">
                <form:option value="-1" label="Select"/>
            ...
            <div class="grid_3 right"> <form:select path="address.stateCode" cssClass="input_full" tabindex="7">
                <form:option value="-1" label="Select"/>
			...
			<div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;">Communication Details</h4> </div>
             ...
             <div class="grid_3 right"><form:input cssClass="input_full" path="defaultPointOfContact.contactName" class="input" tabindex="9"/> </div>
             <div class="s1"></div>
            <div class="grid_2 right"><form:label path="defaultPointOfContact.contactTitle">Contact Title</form:label> </div>
            <div class="grid_3 right"><form:input cssClass="input_full" path="defaultPointOfContact.contactTitle" class="input" tabindex="10"/> </div>
            </div>
			<div class="container_12 pt5">
             <c:forEach items="${partySite.defaultPointOfContact.emailList}" var="email" varStatus="cStatus">
            ...
            <div class="grid_3 right"> 
                ...
                <form:input path="defaultPointOfContact.emailList[${cStatus.index}].contactDetail" tabindex="11" cssClass="input_full"/> </div>
             </c:forEach>
                        
             <div class="s1"></div>
             <c:forEach items="${partySite.defaultPointOfContact.faxList}" var="contact" varStatus="cStatus">
             ...
             <div class="grid_3 right"> 
                ...
                <form:input path="defaultPointOfContact.faxList[${cStatus.index}].contactDetail" tabindex="12" cssClass="input_full"/> </div>
               </c:forEach> 
          </div>
			<div class="container_12 pt5">
                        <div class="grid_2 right">
            			<form:label path="defaultPointOfContact.phoneList">Phone No.</form:label>  </div>
                     <div class="grid_4">
            			...
            			<c:forEach items="${partySite.defaultPointOfContact.phoneList}" var="contact" varStatus="cStatus">
			                <table width="100%">
			                    <tr class="phonerow">
			                        <td width="20%"><form:input path="defaultPointOfContact.phoneList[${cStatus.index}].contactDetail" cssClass="input phoneField" tabindex="${tabOrder}"/>
			                        </td>
			                        ...
			                        <td class="row-nav1"><form:select path="defaultPointOfContact.phoneList[${cStatus.index}].subType" id="phone_type" cssClass="phone_type" tabindex="${tabOrder}">
			                            <form:option value="-1" label="Select"/>
			...
			<div class="container_12">
            	...
            	<security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
	                	<a href="clientLocation.do?clientId=${param.clientId}" style="text-decoration:none;">
	                    	<button type="button" id="newClient"
	                    	onclick="window.location='clientLocation.do?clientId=${param.clientId}';return false;"
...
<span class="legend b">Client Locations</span>
...
jQuery(document).ready(
	function() {
		...
		{
		  url : '<c:url value="/locationList.do?clientId="/>'+ clientId,
		  height :'100%',
		  datatype : 'json',
		  mtype : 'GET',
		 ...
		 colModel : [
			...
			formatter : 'showlink',
		formatoptions : {
			baseLinkUrl : '<c:url value="clientLocation.do"/>',
			idName : 'id',
		...
		jsonReader : {
			...
			editurl : '<c:url value="/saveLocationList.do"/>?clientId='+ clientId
		});
