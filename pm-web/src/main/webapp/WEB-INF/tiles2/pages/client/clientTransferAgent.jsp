...
<div class="f13">
<form:form modelAttribute="partyAccount" method="POST" action="clientTransferAgent.do">
...
<input type="hidden" name="clientId" id="clientId" value="${param.clientId}" />
	...
	<b><strong>${inValidClientId}</strong></b>
		...
		<!-- BEGIN ROW 1 -->
		<div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;margin-top:-3px">Transfer Agency Details</h4></div>
		<div class="container_12 pt5">
            <div class="grid_2 right"><form:label path="accountEntityName">Transfer Agent Name</form:label>      </div>
	...
	<div class="grid_12 blue"><h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;">Address Details</h4></div>
           <div class="container_12 pt5">
            ...
            <div class="grid_3 right"><form:input path="address.addressLine1" cssClass="input_full" tabindex="3"/>      </div>
                        
             <div class="s1"></div>
                    
             <div class="grid_2 right"><form:label cssClass="label"  path="address.addressLine2">Address Line2</form:label>   </div>
            <div class="grid_3 right"><form:input path="address.addressLine2" cssClass="input_full" tabindex="4"/>    </div>
      </div>
		...
		<div class="container_12 pt5">
            ...
            <div class="grid_3 right"><form:input path="address.city" cssClass="input_full" tabindex="5"/>      </div>
                        
             <div class="s1"></div>
                    
             <div class="grid_2 right"><form:label cssClass="label" path="address.countryCode">Country</form:label>   </div>
            <div class="grid_3 right"><form:select path="address.countryCode" tabindex="6" cssClass="input_full" >
		   ...
		   <div class="container_12 pt5">
            ...
            <div class="grid_3 right"><form:select path="address.stateCode" tabindex="7" cssClass="input_full" >
                        	<form:option value="-1" label="Select"/>
            ...
            <div class="grid_3 right"><form:input path="address.postalCode" cssClass="input_full" tabindex="8"/>      </div>
      </div>
            	<!-- BEGIN ROW 3 -->
         ...
         <div class="container_12 pt5">
            ...
            <div class="grid_3 right"><form:hidden
		                ...
		                <form:input
		                        ...
		                        tabindex="11" cssClass="input_full"/>      </div></c:forEach>
		...
		<div class="container_12 pt5">
            ...
            <div class="grid_3 right">
			    ...
			    <form:input path="defaultPointOfContact.webUrlList[${cStatus.index}].contactDetail" tabindex="13" cssClass="input_full"/>      
			 </div>
			 </c:forEach>
      ...
      <div class="container_12 pt5">
            ...
            <div class="grid_5 right"><form:textarea path="terms"
				                           rows="3" cssClass="input_full" tabindex="15"/>      </div>
...
<div class="container_12" style="margin:10px;"></div>
			...
			<div class="container_12">
            	...
            	<security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
	                	<a href="clientTransferAgent.do?clientId=${param.clientId}" style="text-decoration:none;">
	                    	<button type="button" id="newClient"
	                    	onclick="window.location='clientTransferAgent.do?clientId=${param.clientId}';return false;"
	                        	    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
	                            	role="button" aria-disabled="false">
	                        	<span class="ui-button-text">New TransferAgent</span>
	                    	</button>
	                	</a>&nbsp;&nbsp;
...
<span class="legend b">Transfer Agents List</span>
	...
	jQuery(document).ready(
			function() {
				...
				var mygrid = jQuery("#list").jqGrid(
						{
							url : 'accountAjaxList.do?clientId=' + clientId
									+ '&accountCategory=702',
							datatype : 'json',
							...
							colModel : [
								...
								formatter : 'showlink',
								formatoptions : {
									baseLinkUrl : 'clientTransferAgent.do',
									idName : 'id',
			...
			.click(
					function() {
						if ($("tr.phonerow").length < 5) {
							...
							$("table tbody")
									.find("tr.phonerow:last")
									.clone(true)
									.insertAfter("tr.phonerow:last")
