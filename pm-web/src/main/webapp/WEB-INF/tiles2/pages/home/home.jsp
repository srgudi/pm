...
$(function() {
    $("#viewclientList").click(function() {
        $.mobile.changePage("/pm/mobileclient/mobileClientList.do","slideup");
    });        
});
$(function() {
    $("#viewtaskList").click(function() {
        $.mobile.changePage("/pm/mobiletask/mobileTaskList.do","slideup");
    });        
});
$(function() {
    $("#viewfirmadminList").click(function() {
        $.mobile.changePage("/pm/mobilefirmadmin/firmadminhome.do","slideup");
    });        
});
$(function() {
    $("#viewcalendar").click(function() {
        $.mobile.changePage("/pm/calendar/calendarMobile.do","slideup");
    });        
});
/* $(function() {
...
$(function() {
    $("#viewadminList").click(function() {
        $.mobile.changePage("/pm/mobileadmin/mobileAdminList.do","slideup");
    });        
});
</script>
 <script type="text/javascript">
