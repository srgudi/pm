...
<div class="ml20 mr20 mt10">
	...
	<div class="fieldset">
		...
		<div  class="f13">
				<form:form modelAttribute="party" method="POST" action="mobileAdminFirmEmployee.do">
...
jQuery(document).ready(function(){ 
	...
	var mygrid = jQuery("#adminFirmEmployee").jqGrid({
		url:'<c:url value="/appadmin/mainEmployeeList.do"/>?firmId='+firmId,
		datatype: 'json',
		height : 300,
		mtype: 'GET', 
		colNames:['Name', 'Title', 'Role', 'Relationship Type', 'Email', 'Status'],
		colModel :[
			{name:'name', index:'name', formatter: 'showlink', formatoptions: {baseLinkUrl: '<c:url value="/mobileadmin/mobileAdminFirmEmployee.do"/>', 
