...
<div class="error_container">
  ...
  <form:form modelAttribute="party" method="POST" action="mobileAdminFirmModule.do">
                ...
                <div data-role="fieldcontain" >
                   <form:label path="organization.legalName">First Name</form:label>
                   <form:input path="organization.legalName" cssClass="input_full" tabindex="1"/>
                     <c:if test="${party.id != null}">
                  	     <a href="mobileAdminFirmEmployee.do?newfirmId=${party.id}" name="adminEmployee" class="ui-widget" tabindex="1"   onclick="window.location='mobileAdminFirmEmployee.do?newfirmId=${party.id}';return false;" style="text-decoration:none;">
