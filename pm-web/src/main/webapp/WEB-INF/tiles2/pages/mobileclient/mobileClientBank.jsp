...
<security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
	                	<a href="<c:out value='${mobileBankModuleUrl}'/>" style="text-decoration:none;">
	                    	 <button type="button" id="showClientForm" onclick="showBankForm()"
...
<!-- <h4 style="border-bottom:1px solid #ccc;padding-bottom:5px;margin-top:-3px">Bank Details</h4> -->
		...
		<div data-role="fieldcontain" ><form:label path="terms" cssClass="input_full">Memo</form:label>    
            <form:textarea path="terms" rows="3" cssClass="input_full" tabindex="16"/>      </div>
            	...
            	<a href="<c:out value='${mobileBankModuleUrl}'/>" style="text-decoration:none;">
	                    	 <button type="button" id="form" onclick="hideBankForm()"
	                        	    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
	                            	role="button" aria-disabled="false" data-inline="true" data-mini="true">
...
<!-- BUCKET -->
    ...
    <div id="gridBank">	  
    <div id="grid_wrapper" >
        <table id="mobilebanklist" ></table>
        <div id="mobilebankpager"></div>
    </div>
    <script type="text/javascript">
            clientId = $("#clientId").val();
            jQuery("#mobilebanklist").jqGrid({
            	 "hoverrows":false,
                 "viewrecords":true,
                 ...
                 "gridview":true,
                 "loadonce":true,
                 "url":'<c:url value="/client/accountAjaxList.do"/>?clientId=' + clientId + '&accountCategory=700',
                ...
                colModel :[
                    ...
                    {name:'accountType', index:'accountType',  width:150,formatter: 'showlink', formatoptions: {baseLinkUrl: 'mobileClientBank.do',
                ...
                "pager":"#mobilebankpager"
            });
          
            jQuery("#mobilebanklist").jqGrid('filterToolbar', {
                stringResult : true,
                searchOnEnter : false
            });
            $('#mobilebankpager').css("height", "50px");
