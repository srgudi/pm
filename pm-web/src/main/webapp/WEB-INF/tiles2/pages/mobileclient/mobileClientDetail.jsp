...
<form:form name="organization" modelAttribute="organization" method="POST" action="mobileClientDetail.do">
        <input type="hidden" name="clientId" value="${param.clientId }"/>
         <input type="hidden" name="baseURL" id="baseURL" value="mobileClientDetail.do"/> 
    ...
    <form:label path="operatingName">Operating Name</form:label>
                  <!--   <fieldset data-role="controlgroup" data-mini="true"> -->
                    <form:input path="operatingName" cssClass="input_full" tabindex="1"/>
                  <!--   </fieldset> -->
    </div>
    ...
    <form:label path="businessIdentificationNumber">Business Number</form:label>
                    ...
                    <form:input path="businessIdentificationNumber" cssClass="input_full" tabindex="1"/>
    ...
    <form:label path="incorporationNumber">Incorporation Number</form:label>
                    ...
                    <form:input path="incorporationNumber" cssClass="input_full" tabindex="1"/>
    ...
    <form:label path="yearEndDate">Year End Date</form:label>
                    ...
                    <form:input path="yearEndDate" cssClass="input_full" tabindex="1"/>
    ...
    <div data-role="fieldcontain" >
                    ...
                    <form:textarea path="issuedCaptial" name="issuedCaptial" id="issuedCaptial" placeholder=""></form:textarea>
    ...
    <div data-role="fieldcontain" >
                    ...
                    <form:textarea path="authorizedCapital" name="authorizedCapital" id="authorizedCapital" placeholder=""></form:textarea>
                     ...
                     <security:authorize access="hasRole('ROLE_FIRM_PARTNER')">
            			...
            			<c:if test="${organization.id != null}">
	    	                ...
	    	                <a href="mobileClientList.do" style="text-decoration:none;">
	                    	<button type="button" id="newClient"
	                    	onclick="window.location='mobileClientList.do';return false;"
	                        	    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
