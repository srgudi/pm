...
<body onload="hideLocationForm()">
 <div id="divLocation2"  >
<div class="error_container">
	<h7><b>Please correct the following errors </b></h7>
    <ol></ol>
</div>
				<form:form modelAttribute="partySite" method="POST"		action="mobileclientLocation.do">
                ...
                <div data-role="fieldcontain" >
                  ...
                  <div data-role="fieldcontain" ><form:label  path="partySiteType">Type of Location</form:label>
           ...
           <form:select
            ...
            <form:select path="address.stateCode" cssClass="input_full" tabindex="7">
                <form:option value="-1" label="Select"/>
            ...
            <form:input path="address.postalCode" cssClass="input_full" tabindex="8"/> 
            </div>
			
             <div data-role="fieldcontain" >
             <form:label path="defaultPointOfContact.contactName">Contact Name</form:label> 
             <form:input cssClass="input_full" path="defaultPointOfContact.contactName" class="input" tabindex="9"/>
             </div>
            <div data-role="fieldcontain" ><form:label path="defaultPointOfContact.contactTitle">Contact Title</form:label> 
            <form:input cssClass="input_full" path="defaultPointOfContact.contactTitle" class="input" tabindex="10"/> 
            </div>
             ...
             <form:label path="defaultPointOfContact.emailList" cssClass="input_full">Email Address</form:label>
                ...
                <form:input path="defaultPointOfContact.emailList[${cStatus.index}].contactDetail" tabindex="11" cssClass="input_full"/> 
             </div>
             </c:forEach>
             ...
             <c:forEach items="${partySite.defaultPointOfContact.faxList}" var="contact" varStatus="cStatus">
              <div data-role="fieldcontain" >
                ...
                <form:input path="defaultPointOfContact.faxList[${cStatus.index}].contactDetail" tabindex="12" cssClass="input_full"/>
               </div>
               </c:forEach> 
...
<div id="grid_wrapper" >
	...
	<div id="locationPager" class="scroll" ></div>
</div>
...
<script type="text/javascript">
	    ...
	    jQuery("#locationList").jqGrid({
		 ...
		 colModel : [
			...
			formatter : 'showlink',
		formatoptions : {
			baseLinkUrl : 'mobileclientLocation.do',
			idName : 'id',
	    ...
	    jQuery("#locationList").jqGrid('filterToolbar', {
            stringResult : true,
            searchOnEnter : false
        });
	    
	    $('#locationPager').css("height", "50px");
