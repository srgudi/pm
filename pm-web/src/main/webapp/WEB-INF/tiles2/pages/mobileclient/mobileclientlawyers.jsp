 ...
 <div class="error_container">
    ...
    <ol></ol>
		...
		<div data-role="fieldcontain" >
           ...
           <div data-role="fieldcontain" >
            <form:label cssClass="label"  path="address.addressLine1">Address Line1</form:label>    
            <form:input path="address.addressLine1" cssClass="input_full" tabindex="4"/> 
           </div>
                  
            <div data-role="fieldcontain" >
             <form:label cssClass="label"  path="address.addressLine2">Address Line2</form:label>  
            <form:input path="address.addressLine2" cssClass="input_full" tabindex="5"/>    
           </div>
		
		
		<div data-role="fieldcontain" >
           <form:label cssClass="label"  path="address.city">City</form:label>    
            <form:input path="address.city" cssClass="input_full" tabindex="6"/>    
         </div>
                    
          <div data-role="fieldcontain" >
          <form:label cssClass="label" path="address.countryCode">Country</form:label>  
		  ...
		  <div data-role="fieldcontain" >
           <form:label cssClass="label" path="address.stateCode">State/Province</form:label>  
           ...
           <div data-role="fieldcontain" >
           <form:label cssClass="label"  path="address.postalCode">Postal Code</form:label>   
         ...
         <form:input cssClass="input_full" path="defaultPointOfContact.contactName" class="input" tabindex="10"/> 
           ...
           <div data-role="fieldcontain" > 
           <form:label path="defaultPointOfContact.contactTitle">Title</form:label> 
     ...
     <div data-role="fieldcontain" >
           ...
           <form:textarea path="terms" rows="3" cssClass="input_full" tabindex="16"/>
            	...
            	<security:authorize access="hasAnyRole('ROLE_STAFF','ROLE_FIRM_ADMIN')">
            		...
            		<a href="<c:out value='${mobileLawyerModuleUrl}'/>" style="text-decoration:none;">
	                    	 <button type="button" id="form" onclick="hideLawyerForm()"
	                        	    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
	                            	role="button" aria-disabled="false" data-inline="true" data-mini="true">
...
<!-- BUCKET -->
	...
	<div id="grid_wrapper" >
		...
		<div id="lawyerpager" class="scroll"></div>
	</div>
	<script>
		clientId = $("#clientId").val();
           jQuery("#lawyerlist").jqGrid({
        	   "hoverrows":false,
               "viewrecords":true,
               ...
               "gridview":true,
               "loadonce":true,
               "url":'<c:url value="/client/accountAjaxList.do"/>?clientId='+clientId+'&accountCategory=703',              
               "scrollPaging":true,
               pager : jQuery('#pager'),
               "rowNum":10,
               "rowList" : [20,40,60],
		    ...
		    colModel :[ 
		       ...
		       {name:'accountFirmName', index:'accountFirmName',  width:200,formatter: 'showlink', formatoptions: {baseLinkUrl: 'clientLawyerMobile.do', 
			...
			jQuery("#lawyerlist").jqGrid('filterToolbar', {
				stringResult : true,
				searchOnEnter : false
			});
			 $('#lawyerpager').css("height", "50px");	
</script>
</div>
</body>
