...
<style type="text/css">
    ...
    <ol></ol>
        ...
        <form:form modelAttribute="task"  method="POST" action="mobileTaskmodule.do">
        <input type="hidden" name="clientId" value="${param.clientId }"/>
  <input type="hidden" name="taskId" value="${param.taskId }"/>
  <input type="hidden" name="baseURL" id="baseURL" value="/mobiletask/mobileTaskmodule.do"/>
...
<div data-role="fieldcontain" >
            ...
            <div data-role="fieldcontain" >
                    ...
                    <c:choose>
		                  ...
		                  <c:otherwise>
		                  	 <form:input path="dueDate"  id="date" cssClass="input_full" tabindex="5" />
		                  </c:otherwise>
		                </c:choose>
            ...
            <div data-role="fieldcontain" >
                    ...
                    <form:label path="actualCompletionDate">Actual Completion Date</form:label>
            ...
            <div data-role="fieldcontain" >
                    ...
                    <form:label path="staffInCharge">Assigned To</form:label>
            ...
            <div data-role="fieldcontain">
                    ...
                    <form:label path="taskNote"> Notes  </form:label>
                      <fieldset data-role="controlgroup">
                       
                  
                    <form:textarea path="taskNote" name="taskNote" id="taskNote" placeholder=""></form:textarea>
            		...
            		<input data-inline="true" value="Save" id="save" data-mini="true" type="submit">
	             	</c:if>
							<c:if test="${task.id != null}">
						<input data-inline="true" value="Update" id="save" data-mini="true" type="submit">
	    	                </c:if>
