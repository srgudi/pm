...
<div>
	<form:form modelAttribute="taskRep" method="POST" action="clientListwithDetailsJasperReport.do" name="test" target="report">
  ...
  <INPUT TYPE="HIDDEN" id="ReportName" NAME="ReportName" Value="ClientListWithDetails.jasper">
	<input type="hidden" name="baseURL" id="baseURL" value="clientListwithDetailsJasperReport.do" /> 	
