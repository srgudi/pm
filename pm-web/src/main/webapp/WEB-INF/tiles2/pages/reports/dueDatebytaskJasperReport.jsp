...
<div>
	<form:form modelAttribute="taskRep" method="POST" action="dueDateByTaskJASPER.do" name="test" target="report">
	
	 <input type="hidden" name="clientId" value="1"/>
  <input type="hidden" name="taskId" value="2"/>
	<input type="hidden" name="baseURL" id="baseURL" value="dueDateByTaskJASPER.do" /> 	
	...
	<table class="ui-widget" border="0" id="controls1"
		...
		<tbody>
			...
			<tr>
			 ...
			 <tr class="odd">
                  <td class="col-first">Task Type: </td>
                  <td class="col-second">
