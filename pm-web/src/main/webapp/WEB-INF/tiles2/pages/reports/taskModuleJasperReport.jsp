...
<div>
<form:form modelAttribute="taskRep" method="POST" action="taskModuleJasperReport.do" name="test" target="report">
  ...
  <INPUT TYPE="HIDDEN" NAME="ReportName" Value="TaskListByPartner.jrxml">
	<input type="hidden" name="baseURL" id="baseURL" value="taskModuleJasperReport.do" /> 	
