 <%@ include file="../../layout/PM-INCLUDES.jsp" %>
  ...
  <div class="fieldset">
<span class="legend b">Task Documents</span>
    <div class="f13">
...
<span class="legend b">Documents Searched List</span>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
           var mygrid = jQuery("#taskList").jqGrid({
                url:'taskDocumentSearchList.do',
                datatype: 'json',
                height : '100',
                mtype: 'GET',
           ...
           jQuery("#taskList").jqGrid('navGrid', '#pager', {
       	 ...
       	 jQuery("#taskList").jqGrid('navButtonAdd',
                    "#pager", {
       	 ...
       	 jQuery("#taskList").jqGrid('filterToolbar', {
                stringResult : true,
                searchOnEnter : false
            });
             ...
             $().ready(function() {
            	 $("#docSearch").click(function() {
            		 var documentSearchFilter = { groupOp: "AND", rules: []};
	              	...
	              	documentSearchFilter.rules.push({field:"taskId",op:"eq",data:$("#taskId").val()}); 
	              	 documentSearchFilter.rules.push({field:"dueDate",op:"eq",data:$("#docDatepickerDueFrom").val()}); 
	              	 documentSearchFilter.rules.push({field:"dueDateTo",op:"eq",data:$("#docDatepickerDueTo").val()}); 
	         ...
	         //  	 	mygrid[0].p.search = documentSearchFilter.rules.length>0;
	        		...
	        		$("#taskList").setGridParam({datatype:'json', page:1}).trigger('reloadGrid');
            	 });
            });
        });
        ...
        $(window).bind('resize',
                function() {
                    jQuery("#taskList").setGridWidth($('#grid_wrapper').width() - 5, true);
                }).trigger('resize');
